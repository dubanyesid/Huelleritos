...
<html lang="en">
    ...
    <body>
		...
		<jsp:include page="menuAdmin.jsp" />
			...
			if(enfermedades==null ||codigo==null){
			...
			%>
				...
				<a class="btn btn-primary btn-customized open-menu" href="#" role="button">
                    <i class="fas fa-align-left"></i> <span>Menu</span>
               			...
               			<h2><strong>AGREGAR ENFERMEDAD</strong></h2> <br>
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="addEnfermedad/enviar">
                        ...
                        <li>
                            <div ><h6>NOMBRE ENFERMEDAD</h6>
                            	<select name="enfermedad">
  								...
  								%>
  								<option value="<%=enfermedad.getCodigoEnfermedad()%>"><%=enfermedad.getNombreEnfermedad() %></option>
  								<%
  								}
  								%>
								</select>
