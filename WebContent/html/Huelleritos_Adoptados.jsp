...
<body>
    ...
    <br>
    <%
		List<Animal> adoptados = (List<Animal>) (request.getAttribute("listAdoptados"));
	Animal[] animales = new Animal[adoptados.size()];
	animales = adoptados.toArray(animales);
	%>
	<div class="container">
		<%
			int c = adoptados.size() < 3 ? 3 : adoptados.size();
		int j = 0;
		if (c == 0) {
		%>
