...
<title>Perfil Animal Adoptado</title>
		...
		<div class="col-sm-4">
			...
			<br> <a href="<%=request.getContextPath()%>/HogarDePaso"
				target="blank"><button type="button"
					class="btn btn-dark btn-lg ">Hogar de Paso</button></a><br>
			<br>
			<form action="<%=request.getContextPath()%>/Seguimiento"
				...
				<input name="idAnimalSeg" value="<%=a.getCodigoAnimal()%>"
					...
					value="<%=a.getNombreAnimal()%>" type="hidden"> <a
					href="<%=request.getContextPath()%>/Seguimiento" target="blank"><button
