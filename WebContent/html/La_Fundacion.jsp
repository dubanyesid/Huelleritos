				...
				<div class="row">
					<div class="col-lg-5 col-md-6">
						<div class="slider_text">
							<h3>
								<span>Fundación</span><br>Huelleritos
							</h3>
							<p>La Fundacion Huelleritos es una organizacion sin animo de
								lucro que busca dar hogar, rehabilitar y dar en adopcion a
								perros que son rescatados en estado de maltrato.</p>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 centro">
				<h2>Historia</h2>
				<p>Huelleritos nació hace 3 años en la ciudad de Cúcuta con la
					finalidad de ayudar a los animales en condición de calle. El equipo
					está conformado por 2 rescatistas, Natalia Ortiz y Jenifer
					Bautista, quienes han dedicado su tiempo a intentar sanar las
					heridas de todos aquellos peludos victimas del maltrato y la
					indiferencia. Huelleritos trabaja de la mano con la veterinaria
					Zoolomascotas, donde son atendidos todos los rescatados a precios
					muy cómodos. Actualmente, la fundación no tiene refugio propio pero
					ingresa sus casos al refugio de Doña Martha en donde hay al rededor
					de 35 perros y 25 gatos.</p>
				</p>
			</div>
			...
			<div class="col-sm-6">
				<div class="row">
					<div class="col-sm-6">
						<img
							src="https://www.consumer.es/wp-content/uploads/2019/07/img_sentarse-perro-300x300.jpg"
							class="img-fluid" alt="Responsive image">
					</div>
					<div class="col-sm-6">
						<img
							src="https://www.consumer.es/wp-content/uploads/2019/07/img_perros-se-masturban1-300x300.jpg"
							class="img-fluid" alt="Responsive image">
					</div>
				</div>
				<br> <img
					src="https://cdn.shortpixel.ai/client/q_glossy,ret_img,w_1000/https://naturalchoice.ec/wp-content/uploads/2020/01/header-1.jpg"
					class="img-fluid" alt="Responsive image">
			</div>
		</div>
		<br>
		<br>
		<h2 class="centro">
			Trabajando en pro de los animales<br> Nuestra mision
			<hr>
		</h2>
		<br>
		<br>
		<div class="row">
			<div class="col-sm-6 centro">
				...
				<p>Los animales que llegan a la fundacion reciben atencion
					veterinaria completa, incluyendo esterilizacion, vacunacion,
					desparacitacion y cualquier tratamiento necesario para garantizar
					su bienestar hasta que logremos encontrarle un hogar que los cuide
					de por vida</p>

				<img
					src="https://static.affinity-petcare.com/advance/cdn/farfuture/FnciLwPxwEfGjMY3DnH1maXtV9f366_gvdlJfqxw2SI/drupal-cache:qnut8e/sites/default/files/styles/article-list/public/field/image/perro-cansado.jpg?itok=jfmn1FS6"
					class="img-fluid" alt="Responsive image">
				<h5>Category 1</h5>
				<a href="">Learn more</a>
			</div>
			<div class="col-sm-6 centro">
				...
				<p>Promover la sensibilizacion colectiva fomentando la
					esterilizacion, respeto a la vida, el no al matrato animal y la
					adopcion responsable. Soñamos con convertirnos en una organizacion
					lider en la proteccion y preservacion de los animales que son
					victimar del maltrato y la indiferencia</p>

				<img
					src="https://static.affinity-petcare.com/advance/cdn/farfuture/4-WmoVwzUNsivsjEFj2sR5VsjUTBfk5N5hOelOXbV_0/drupal-cache:qo7uxl/sites/default/files/styles/article-list/public/field/image/mi_perro_se_ha_hecho_dano_en_una_pata_1_opt.jpg?itok=lFF31X0u"
					class="img-fluid" alt="Responsive image">
				<h5>Category 2</h5>
				<a href="">Learn more</a>
			</div>
