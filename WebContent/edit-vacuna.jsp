...
<html lang="en">
    ...
    <body>
		...
		<!-- Wrapper -->
			...
			<%
                VacunaHistorial vacunaMia = (VacunaHistorial) request.getAttribute("vacuna");
				List<Vacuna> vacunas = (List<Vacuna>) request.getAttribute("vacunas");
                if(vacunaMia==null || vacunas==null){
				...
				<a class="btn btn-primary btn-customized open-menu" href="#" role="button">
                    <i class="fas fa-align-left"></i> <span>Menu</span>
               			  ...
               			  <h2><strong>EDITAR VACUNA</strong></h2> <br>
                        <h3><strong>ID ANIMAL #<%=vacunaMia.getHistorialAnimal().getAnimal().getCodigoAnimal() %></strong></h3>
                    <div class="container">

        
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="editVacuna/enviar">
                <input name="idVacuna" hidden value="<%=vacunaMia.getIdVacunaHistorial()%>">
                    <ul class="contact-form">
                        <li>
                            <div ><h6>NOMBRE VACUNA</h6>
                                ...
                                %>
                                <option <%=vacuna.getCodigoVacuna().equals(vacunaMia.getVacuna().getCodigoVacuna())?"selected":"" %> value="<%=vacuna.getCodigoVacuna() %>"><%=vacuna.getNombreVacuna() %></option>
                                <%
                                }
                                %>
                                </select>
                            ...
                            <div ><h6>FECHA VACUNACION</h6>
                                <input name="fecha" value="<%=sdf.format(vacunaMia.getFechaVacunacion())%>" placeholder="Escribe la Fecha" required="required" size="8" type="date" />
                            </div>
