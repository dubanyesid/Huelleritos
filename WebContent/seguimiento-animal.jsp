...
<form method="post" action="Evidencia/Enviar">

					<div class="form-group row justify-content-center">
						<label for="" class="col-sm-7 col-lg-12 col-form-label">Nombre</label>
						<div class="col-sm-5 col-lg-4">
							...
							<select name="animal" class="form-control">
								...
								%>
								<option value="<%=animal.getCodigoAnimal()%>"><%=animal.getNombreAnimal() + " - " + animal.getTipoAnimal().getDescripcion()%></option>
								<%
								}
								}
								%>
					...
					<div class="form-group row justify-content-center">
						<label for="descripcion" class="col-sm-7 col-lg-12 col-form-label">Descripción</label>
