...
public class NoticiaEvidenciaController extends HttpServlet {
	...
	private void index(HttpServletRequest request, HttpServletResponse response)
		...
		// mostrar(request, response);
		RequestDispatcher dispatcher = request.getRequestDispatcher("../WebContent/administrador/noticia-evidencia.jsp");
	...
	private void registrar(HttpServletRequest request, HttpServletResponse response)
		...
		NoticiaEvidencia ne = new NoticiaEvidencia(id+1, request.getParameter("titulo"), request.getParameter("descripcion"), 
