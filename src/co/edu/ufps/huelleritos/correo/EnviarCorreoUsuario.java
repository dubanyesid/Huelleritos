...
public class EnviarCorreoUsuario {
	...
	public boolean enviarCorreo(String nombreArchivo, String rol, File img,String nombreAnimal,Usuario us, Formulario formulario) {
		...
		try {
			...
			creado=generarPDF.generarPDF(nombreArchivo, rol, img,nombreAnimal,us, formulario);
